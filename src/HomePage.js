  ...
  return (
    <div className="App">
      <Helmet>
        ...
        <meta name="keywords" content="eloquently, Eloquence, eloquence, Eloquence.live, sign language, object detection, hand tracking, mediapipe, tensorflow, accessibility, inclusivity, machine learning, sign language translation, eloquence, eloquence.live, sign" />
